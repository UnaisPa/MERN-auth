...
const Hero = () => {
  ...
  return (
    <>
        <div className=' text-white text-center h-full mt-10 pt-20'>
            ...
            {currentUser?(<p className='mt-10'>👋 Hello {currentUser.name}</p>):(<div className="mt-10 flex items-center justify-center gap-x-6">
              <Link to='/login'>
              <button
